...
const menuItems = [
  { id: 1, label: "Home", icon: FaHome, link: "/enfermera" },
  { id: 2, label: "Citas", icon: FaCalendar, link: "/enfermera/citas" },
  { id: 3, label: "Carnets", icon: FaUsers, link: "/enfermera/carnets" },
];
function SidebarEnf() {
